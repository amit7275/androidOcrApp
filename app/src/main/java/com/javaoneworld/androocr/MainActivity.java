package com.javaoneworld.androocr;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnScanImage = findViewById(R.id.scan_button);
        octTextView = findViewById(R.id.ocr_text);
        scannedImage = findViewById(R.id.ocr_image);
